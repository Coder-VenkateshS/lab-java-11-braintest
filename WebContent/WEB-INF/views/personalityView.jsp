...
<main>HERE YOU GO... </main>
  ...
  <div class="quiz-container">
    ...
    <div class="rating">
        ...
        <label for="super-happy2" class="option">
			<input type="radio" name="option" class="super-happy" id="super-happy2" value="5" checked />
        ...
        <label for="happy2" class="option">
			<input type="radio" name="option" class="happy" id="happy2" value="4" />
        ...
        <label for="neutral2" class="option">
			<input type="radio" name="option" class="neutral" id="neutral2" value="3" />
        ...
        <label for="sad2" class="option">
			<input type="radio" name="option" class="sad" id="sad2" value="2" />
        ...
        <label for="super-sad2" class="option">
			<input type="radio" name="option" class="super-sad" id="super-sad2" value="1" />
	...
	<input type="hidden" name="selectedOptions" id="selectedOptions"/>
        ...
        <!-- Buttons -->
        <div class="controls">
            <button type="button" class="previous" value=>PREVIOUS</button>
            <button type="button" class="next" onclick=generateQuestions>NEXT</button>
        </div>
     </div>
      </form>
